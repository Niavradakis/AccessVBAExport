...
ErrorHandler:
    MsgBox "The following error has occurred" & vbCrLf & vbCrLf & _
           "Error Number: " & Err.Number & vbCrLf & _
           "Error Source: εδώ βάζουμε την sub ή function" & vbCrLf & _
           "Error Description: " & Err.Description _
           , vbOKOnly + vbCritical, "An Error has Occurred!"
    Resume ExitProcedure
End Sub
...
VarProcedureTitle = "ΕΔΩ ΒΑΖΟΥΜΕ ΤΟΝ ΤΙΤΛΟ ΤΗΣ PROCEDURE"
VarModuleName = "Me.Name" ' να βγουν τα "". Τα εβαλα γιατι χτυπαγε το me.name οταν εκανα test compile τη βαση. Αν πρόκειται για module που δεν ανήκει σε φόρμα, τότε αντί για me.name βάζουμε VarModuleName = "το όνομα του module"
