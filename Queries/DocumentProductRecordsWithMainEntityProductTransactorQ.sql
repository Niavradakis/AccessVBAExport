SELECT IssuedDocumentProductDetailsT.*, IssuedDocumentT.[Financial_Transaction_Point_ID(Main_Entity)], IssuedDocumentT.[Transactor_Product_ID(Main_Entity)], IssuableDocumentT.[Main_Entity_Debited(For_Product_Documents)] AS [TICK=Debitor-UNTICK=Creditor], IssuableDocumentT.Affects_Inventory, False AS Is_Financial, True AS iIs_Product
