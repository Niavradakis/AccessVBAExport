...
Select Case Err.Number
        Case 3314
        MsgBox "You have left empty fields which must be filled", vbInformation, "Μήνυμα σφάλματος"
...
Case 1 ' product
   EntityInfoForSubattributes = "Περιγραφή : " & Nz(DLookup("ProductsSimpleQ.Product_Description", "ProductsSimpleQ", "ProductsSimpleQ.Product_ID = " & EntityIDint), "-") & "," & _
   ...
   vbCrLf & "Τύπος : " & Nz(DLookup("ProductsSimpleQ.Type_Description", "ProductsSimpleQ", "ProductsSimpleQ.Product_ID = " & EntityIDint), "-") & "," & _
   vbCrLf & "Κατηγορία : " & Nz(DLookup("ProductsSimpleQ.Category_Description", "ProductsSimpleQ", "ProductsSimpleQ.Product_ID = " & EntityIDint), "-") & "," & _
   vbCrLf & "Υποκατηγορία : " & Nz(DLookup("ProductsSimpleQ.Subcategory_Description", "ProductsSimpleQ", "ProductsSimpleQ.Product_ID = " & EntityIDint), "-") & "," & _
...
Case 2 ' transactor
   EntityInfoForSubattributes = "Περιγραφή : " & Nz(DLookup("TransactorsWithBasicTransactorsDescriptionQ.Basic_Transactor_Description", "TransactorsWithBasicTransactorsDescriptionQ", "TransactorsWithBasicTransactorsDescriptionQ.Transactor_ID = " & EntityIDint), "-") & "," & _
   vbCrLf & "Τύπος Συναλλασσόμενου : " & Nz(DLookup("TransactorsWithBasicTransactorsDescriptionQ.Transactor_Type_Desription", "TransactorsWithBasicTransactorsDescriptionQ", "TransactorsWithBasicTransactorsDescriptionQ.Transactor_ID = " & EntityIDint), "-")
Case 3 'document issued
   EntityInfoForSubattributes = "Περιγραφή: " & Nz(DLookup("IssuedDocumentSimpleQ.Issuable_Document_Description", "IssuedDocumentSimpleQ", "IssuedDocumentSimpleQ.Issued_Document_ID = " & EntityIDint), "-") & "," & _
   vbCrLf & "Νο.: " & Nz(DLookup("IssuedDocumentSimpleQ.Document_Official_Number_Sequence", "IssuedDocumentSimpleQ", "IssuedDocumentSimpleQ.Issued_Document_ID = " & EntityIDint), "-") & "," & _
   " Σειρά : " & Nz(DLookup("IssuedDocumentSimpleQ.Distinction_Additive", "IssuedDocumentSimpleQ", "IssuedDocumentSimpleQ.Issued_Document_ID = " & EntityIDint), "-") & "," & _
   " Ημ/νία : " & Nz(DLookup("IssuedDocumentSimpleQ.Issued_Date", "IssuedDocumentSimpleQ", "IssuedDocumentSimpleQ.Issued_Document_ID = " & EntityIDint), "-") & "," & _
   vbCrLf & "Εκδότης : " & Nz(DLookup("IssuedDocumentSimpleQ.Document_Issuer_Description", "IssuedDocumentSimpleQ", "IssuedDocumentSimpleQ.Issued_Document_ID = " & EntityIDint), "-") & "," & _
   vbCrLf & "Σκοπός : " & Nz(DLookup("IssuedDocumentSimpleQ.Intention_Description", "IssuedDocumentSimpleQ", "IssuedDocumentSimpleQ.Issued_Document_ID = " & EntityIDint), "-")
Case 4 ' document financial details
   If IsNull(DLookup("IssuedDocumentFinancialDetailsSimpleQ.Debit", "IssuedDocumentFinancialDetailsSimpleQ", "IssuedDocumentFinancialDetailsSimpleQ.IssuedDocumentFinancialDetailsT.Issued_Document_Financial_Details_ID = " & EntityIDint)) Then
      valuetobring = "ΧΡΕΩΣΗΣ: " & Format(DLookup("IssuedDocumentFinancialDetailsSimpleQ.Debit", "IssuedDocumentFinancialDetailsSimpleQ", "IssuedDocumentFinancialDetailsSimpleQ.[IssuedDocumentFinancialDetailsT.Issued_Document_Financial_Details_ID] = " & EntityIDint), "currency")
   Else
      valuetobring = "ΠΙΣΤΩΣΗΣ: " & Format(DLookup("IssuedDocumentFinancialDetailsSimpleQ.Credit", "IssuedDocumentFinancialDetailsSimpleQ", "IssuedDocumentFinancialDetailsSimpleQ.[IssuedDocumentFinancialDetailsT.Issued_Document_Financial_Details_ID] = " & EntityIDint), "currency")
   End If
   EntityInfoForSubattributes = "Περιγραφή: " & Nz(DLookup("IssuedDocumentFinancialDetailsSimpleQ.Issuable_Document_Description", "IssuedDocumentFinancialDetailsSimpleQ", "IssuedDocumentFinancialDetailsSimpleQ.[IssuedDocumentFinancialDetailsT.Issued_Document_Financial_Details_ID] = " & EntityIDint), "-") & "," & _
   vbCrLf & "Νο.: " & Nz(DLookup("IssuedDocumentFinancialDetailsSimpleQ.Document_Official_Number_Sequence", "IssuedDocumentFinancialDetailsSimpleQ", "IssuedDocumentFinancialDetailsSimpleQ.[IssuedDocumentFinancialDetailsT.Issued_Document_Financial_Details_ID] = " & EntityIDint), "-") & "," & _
   " Σειρά : " & Nz(DLookup("IssuedDocumentFinancialDetailsSimpleQ.Distinction_Additive", "IssuedDocumentFinancialDetailsSimpleQ", "IssuedDocumentFinancialDetailsSimpleQ.[IssuedDocumentFinancialDetailsT.Issued_Document_Financial_Details_ID] = " & EntityIDint), "-") & "," & _
   " Ημ/νία : " & Nz(DLookup("IssuedDocumentFinancialDetailsSimpleQ.Issued_Date", "IssuedDocumentFinancialDetailsSimpleQ", "IssuedDocumentFinancialDetailsSimpleQ.[IssuedDocumentFinancialDetailsT.Issued_Document_Financial_Details_ID] = " & EntityIDint), "-") & "," & _
   vbCrLf & "Εκδότης : " & Nz(DLookup("IssuedDocumentFinancialDetailsSimpleQ.Document_Issuer_Description", "IssuedDocumentFinancialDetailsSimpleQ", "IssuedDocumentFinancialDetailsSimpleQ.[IssuedDocumentFinancialDetailsT.Issued_Document_Financial_Details_ID] = " & EntityIDint), "-") & "," & _
   vbCrLf & "Σκοπός : " & Nz(DLookup("IssuedDocumentFinancialDetailsSimpleQ.Intention_Description", "IssuedDocumentFinancialDetailsSimpleQ", "IssuedDocumentFinancialDetailsSimpleQ.[IssuedDocumentFinancialDetailsT.Issued_Document_Financial_Details_ID] = " & EntityIDint), "-") & "," & _
   vbCrLf & "Συν/σόμενος : " & Nz(DLookup("IssuedDocumentFinancialDetailsSimpleQ.Basic_Transactor_Description", "IssuedDocumentFinancialDetailsSimpleQ", "IssuedDocumentFinancialDetailsSimpleQ.[IssuedDocumentFinancialDetailsT.Issued_Document_Financial_Details_ID] = " & EntityIDint), "-") & "," & _
   ...
   " Τύπος : " & Nz(DLookup("IssuedDocumentFinancialDetailsSimpleQ.Transactor_Type_Desription", "IssuedDocumentFinancialDetailsSimpleQ", "IssuedDocumentFinancialDetailsSimpleQ.[IssuedDocumentFinancialDetailsT.Issued_Document_Financial_Details_ID] = " & EntityIDint), "-") & "," & _
   vbCrLf & "Αξία " & valuetobring
Case 5 'document product details
   ...
   vbCrLf & "Νο.: " & Nz(DLookup("IssuedDocumentProductDetailsSimpleQ.Document_Official_Number_Sequence", "IssuedDocumentProductDetailsSimpleQ", "IssuedDocumentProductDetailsSimpleQ.[IssuedDocumentProductDetailsT.Issued_Document_Product_Details_ID] = " & EntityIDint), "-") & "," & _
...
Case 6 'transaction
   EntityInfoForSubattributes = "Τύπος Συναλλαγής: " & Nz(DLookup("TransactionsSimpleQ.Transaction_Type_Description", "TransactionsSimpleQ", "TransactionsSimpleQ.Transaction_ID = " & EntityIDint), "-") & "," & _
   vbCrLf & "Νο Συναλλαγής : " & EntityIDint
Case 8 ' Action
